...
# API Gateway Rest API Lambda Proxy Integration https://docs.aws.amazon.com/cdk/api/v1/python/aws_cdk.aws_apigateway/LambdaRestApi.html
...
# Lambda Deployment Group - https://docs.aws.amazon.com/cdk/api/v1/python/aws_cdk.aws_codedeploy/LambdaDeploymentGroup.html https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-groups.html
